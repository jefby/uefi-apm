  ...
  )
{
  ...
  Print(L"Starting Address of the %s: ", FileName);
  UnicodeSPrint (StrStartingAddress, BOOT_DEVICE_ADDRESS_MAX, L"0x%llX", (EFI_PHYSICAL_ADDRESS)EndingDevicePath->StartingAddress);
  ...
  Print(L"Ending Address of the %s: ", FileName);
  UnicodeSPrint (StrEndingAddress, BOOT_DEVICE_ADDRESS_MAX, L"0x%llX", (EFI_PHYSICAL_ADDRESS)EndingDevicePath->EndingAddress);
