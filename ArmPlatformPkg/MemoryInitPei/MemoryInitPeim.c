  ...
  )
{
  ...
  DEBUG ((EFI_D_ERROR, "Memory size: 0x%llx\n", (UINT64)PcdGet64(PcdSystemMemorySize)));

  SystemMemoryBase = FixedPcdGet64 (PcdSystemMemoryBase);
  SystemMemoryTop = SystemMemoryBase + (UINT64) PcdGet64(PcdSystemMemorySize);
