  ...
  if (ArmIsMpCore()) {
    ...
    *ArmCoreTable = mArmPlatformNullMpCoreInfoTable;
    for (Count = 0; Count < *CoreCount; Count++) {
      mArmPlatformNullMpCoreInfoTable[Count].MailboxClearAddress += (UINT64)PcdGet64 (PcdSystemMemoryBase);
      mArmPlatformNullMpCoreInfoTable[Count].MailboxSetAddress += (UINT64)PcdGet64 (PcdSystemMemoryBase);
      mArmPlatformNullMpCoreInfoTable[Count].MailboxGetAddress += (UINT64)PcdGet64 (PcdSystemMemoryBase);
    }
    return EFI_SUCCESS;
  } else {
