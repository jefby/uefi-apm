...
#if !defined(__XGENEPCIESERDES_H__)
#define __XGENEPCIESERDES_H__
...
#define STMC_OVERRIDE_SHIFT_MASK  0x0
#define STMC_OVERRIDE_SET(dst, src) (((dst) & ~STMC_OVERRIDE_MASK) | \
          (((uint32_t)(src) << STMC_OVERRIDE_SHIFT_MASK) \
          & STMC_OVERRIDE_MASK))
...
#define DN_MAN_ENA_SHIFT_MASK   0x0
#define DN_MAN_ENA_SET(dst, src)  (((dst) & ~DN_MAN_ENA_MASK) | \
          (((uint32_t)(src) << DN_MAN_ENA_SHIFT_MASK) \
          & DN_MAN_ENA_MASK))
