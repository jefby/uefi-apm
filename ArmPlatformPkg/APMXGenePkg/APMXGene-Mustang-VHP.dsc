...
[BuildOptions]
  #
  # Enable this option to run from GFC NOR on hardware
  GCC:*_*_AARCH64_ARCHCC_FLAGS = -mgeneral-regs-only -DARM_CPU_AARCH64 -DAPM_XGENE -DAPM_XGENE_GFC_FLASH
...
[PcdsFixedAtBuild.common]
   ...
   # Value for VHP
   #gEmbeddedTokenSpaceGuid.PcdTimerPeriod|1000000
   # Value for HW
   ...
   gArmPlatformTokenSpaceGuid.PcdTTBBaseAddr|0x1D0F6000
   ...
   gArmPlatformTokenSpaceGuid.PcdDefaultBootArgument|"console=ttyS0,115200 earlyprintk=uart8250-32bit,0x1c020000 root=/dev/ram rw debug"
   gArmPlatformTokenSpaceGuid.PcdDefaultBootDevicePath|L"VenHw(02118005-9DA7-443A-92D5-781F022AEDBB)/MemoryMapped(0x0,0x800000,0x10FFFFF)"
   gArmPlatformTokenSpaceGuid.PcdFdtDevicePath|L"VenHw(02118005-9DA7-443A-92D5-781F022AEDBB)/MemoryMapped(0x0,0x1500000,0x150FFFF)"
   gArmPlatformTokenSpaceGuid.PcdDefaultBootInitrdPath|L"VenHw(02118005-9DA7-443A-92D5-781F022AEDBB)/MemoryMapped(0x0,0x1600000,0x1BFFFFF)"
