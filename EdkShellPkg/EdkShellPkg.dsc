...
# TODO: Fix warnings in EdkShell and remove -Wno-* CC flags
  GCC:*_*_AARCH64_CC_FLAGS     = -DEFIARM $(GCC_MACRO) -Wno-error=unused-but-set-variable -Wno-unused-but-set-variable -Wno-error=switch
  GCC:*_*_AARCH64_VFRPP_FLAGS  = -DEFIARM $(GCC_MACRO)
  GCC:*_*_AARCH64_APP_FLAGS    = -DEFIARM $(GCC_MACRO)
  GCC:*_*_AARCH64_PP_FLAGS     = -DEFIARM $(GCC_MACRO)
