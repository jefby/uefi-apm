...
#define TT_BLOCK_ENTRY_SIZE_AT_LEVEL(TableLevel)     (1ULL << TT_ADDRESS_OFFSET_AT_LEVEL(TableLevel))
...
#define TTBR_ASID_MASK                       (0xFFULL << TTBR_ASID_FIELD)
#define TTBR_BADDR_MASK                      (0xFFFFFFFFFFFFULL ) // The width of this field depends on the values in TxSZ. Addr occupies bottom 48bits
...
#define TCR_EL1_T0SZ_MASK                    (0x1FULL << TCR_EL1_T0SZ_FIELD)
#define TCR_EL1_EPD0_MASK                    (0x1ULL  << TCR_EL1_EPD0_FIELD)
#define TCR_EL1_IRGN0_MASK                   (0x3ULL  << TCR_EL1_IRGN0_FIELD)
#define TCR_EL1_ORGN0_MASK                   (0x3ULL  << TCR_EL1_ORGN0_FIELD)
#define TCR_EL1_SH0_MASK                     (0x3ULL  << TCR_EL1_SH0_FIELD)
#define TCR_EL1_TG0_MASK                     (0x1ULL  << TCR_EL1_TG0_FIELD)
#define TCR_EL1_T1SZ_MASK                    (0x1FULL << TCR_EL1_T1SZ_FIELD)
#define TCR_EL1_A1_MASK                      (0x1ULL  << TCR_EL1_A1_FIELD)
#define TCR_EL1_EPD1_MASK                    (0x1ULL  << TCR_EL1_EPD1_FIELD)
#define TCR_EL1_IRGN1_MASK                   (0x3ULL  << TCR_EL1_IRGN1_FIELD)
#define TCR_EL1_ORGN1_MASK                   (0x3ULL  << TCR_EL1_ORGN1_FIELD)
#define TCR_EL1_SH1_MASK                     (0x3ULL  << TCR_EL1_SH1_FIELD)
#define TCR_EL1_TG1_MASK                     (0x1ULL  << TCR_EL1_TG1_FIELD)
#define TCR_EL1_IPS_MASK                     (0x7ULL  << TCR_EL1_IPS_FIELD)
#define TCR_EL1_AS_MASK                      (0x1ULL  << TCR_EL1_AS_FIELD)
#define TCR_EL1_TBI0_MASK                    (0x1ULL  << TCR_EL1_TBI0_FIELD)
#define TCR_EL1_TBI1_MASK                    (0x1ULL  << TCR_EL1_TBI1_FIELD)
