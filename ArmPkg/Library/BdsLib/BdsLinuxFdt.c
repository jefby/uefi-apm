  ...
  )
{
  ...
  *RelocatedFdtAlloc = *RelocatedFdt;
  ...
  Error = fdt_open_into ((VOID*) OriginalFdt,
            (VOID*)(*RelocatedFdt), *RelocatedFdtSize);
  if (Error) {
  ...
  )
{
  ...
  //
  err = fdt_check_header ((VOID*)(*FdtBlobBase));
  if (err != 0) {
...
//    DebugDumpFdt (fdt);
  ...
  *FdtBlobSize = (UINTN)fdt_totalsize ((VOID*)(NewFdtBlobBase));
  return EFI_SUCCESS;
...
FAIL_RELOCATE_FDT:
  *FdtBlobSize = (UINTN)fdt_totalsize ((VOID*)(*FdtBlobBase));
